...
kings1 <- read.csv("data/Danske_konger-kopi.csv")
head(kings1)
glimpse(kings1)
class(kings1)

kings2 <- read_csv("data/Danske_konger-kopi.csv")
glimpse(kings2)
class(kings2)


kings3 <- read.csv2("data/Danske_konger-kopi.csv")
head(kings3)
glimpse(kings3)
class(kings3)

kings4 <- read_csv2( "data/Danske_konger-kopi.csv")
head(kings4)
glimpse(kings4)
class(kings4)
```
...
kings <- read.csv2( "data/Danske_konger-kopi.csv")
...
```{r eval=TRUE}
kingsduration <- kings %>% 
  mutate(duration=kings$reign_end_year-kings$reign_start_year)
```
...
kingsduration <- kings %>% 
  mutate(duration=kings$reign_end_year-kings$reign_start_year) %>% 
  mutate(midyear=kingsduration$reign_start_year+kingsduration$duration/2)
